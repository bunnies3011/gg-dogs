...
bool loadMedia()
{
    ...
    gStretchedSurface = loadSurface("src/05_optimized_surface_loading_and_soft_stretching/stretch.bmp");
    ...
    else
    {
        ...
        else
        {
            ...
            while (!quit)
            {
                ...
                SDL_BlitSurfaceScaled(gStretchedSurface, NULL, gScreenSurface, &stretchRect, SDL_SCALEMODE_LINEAR);
